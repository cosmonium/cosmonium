...
static const struct rock rocks[N_ROCKS] = {
...
static int
evaluate_rock( const double jde, const int jpl_id, double *output_vect)
{
   int i;
   const struct rock *rptr = rocks;
...
LPoint3d
rckin_sat_pos(double jd, int body)
{
  double loc[3];
  evaluate_rock(jd, body, loc);
