...
from cosmonium.astro.tables import uniform, vsop87, wgccre, lieske_e5, elp82, meeus, gust86, dourneau, rckin
...
class CosmoniumApp(Cosmonium):
    ...
    def load_universe_cosmonium(self):
        parser = UniverseYamlParser(self.universe)
        parser.set_translation(self.load_lang('main', 'data/locale'))
