...
class Preferences(ParamEditor):
    ...
    def make_orbits(self):
        ...
        for label, param_name in orbits:
            params.append(
                ParametricFunctionParameter(
                    label,
                    param_name,
                    bodyClasses.set_show_orbit,
                    bodyClasses.get_show_orbit,
                    SettingParameter.TYPE_BOOL,
                )
            )
        return params
        ...
        return [
            ParametersGroup(
                ...
                [
                    ParametricFunctionParameter(
                        label,
                        param_name,
                        bodyClasses.set_show_label,
                        bodyClasses.get_show_label,
                        SettingParameter.TYPE_BOOL,
                    )
            ...
            ParametersGroup(
                ...
                [
                    ...
                    SettingParameter(
                        _("Constellation label size"), 'constellations_label_size', UserParameter.TYPE_INT, [4, 32]
                    ),
                ],
            ),
        ]
    ...
    def make_render(self):
        return [
            ParametersGroup(
                ...
                [
                    ParametricFunctionParameter(
                        _('Galaxies'), 'galaxy', bodyClasses.set_show, bodyClasses.get_show, SettingParameter.TYPE_BOOL
                    ),
                ],
            ),
        ...
        return [
            ParametersGroup(
                ...
                [
                    ...
                    SettingParameter(
                        _("Cull far patches threshold"), 'cull_far_patches_threshold', UserParameter.TYPE_INT, [5, 25]
                    ),
