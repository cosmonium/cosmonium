...
class FilterManager(DirectObject):
    ...
    def renderSceneInto(self, depthtex=None, colortex=None, auxtex=None, auxbits=0, textures=None, rgbabits=(1, 1, 1, 1), floatcolor=False, srgb=False, depthbits=1, floatdepth=False, multisamples=0):
        ...
        * All clears are disabled on the original display region.
        ...
        buffer = self.createBuffer("filter-base", winx, winy, texgroup, rgbabits=rgbabits, floatcolor=floatcolor, srgb=srgb, depthbits=depthbits, floatdepth=floatdepth, multisamples=multisamples)
    ...
    def createBuffer(self, name, xsize, ysize, texgroup, rgbabits=(1, 1, 1, 1), floatcolor=False, srgb=False, depthbits=1, floatdepth=False, multisamples=0):
