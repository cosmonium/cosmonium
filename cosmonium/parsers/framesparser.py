...
class FrameYamlParser(YamlModuleParser):
    ...
    def decode(cls, data, parent=None, default='j2000ecliptic'):
        ...
        if object_type == 'j2000ecliptic':
            return cls.decode_j2000_ecliptic(parameters, parent)
        elif object_type == 'j2000equatorial':
            return cls.decode_j2000_equatorial(parameters, parent)
            ...
            return cls.decode_fixed(parameters, parent)
        elif object_type == 'equatorial':
            return cls.decode_equatorial(parameters, parent)
        elif object_type == 'mean-equatorial':
            return cls.decode_mean_equatorial(parameters, parent)
        else:
