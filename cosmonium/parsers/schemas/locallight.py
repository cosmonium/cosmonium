...
class LocalDirectionalLightConfig(ConfigBase):
    ...
    position: Optional[List[float]] = Field([0, 0, 0], description="Light position [x, y, z]")
    color: Optional[List[float]] = Field([1, 1, 1], description="Light color [r, g, b] or [r, g, b, a]")
    power: float = Field(1.0, description="Light power multiplier")
    direction: Optional[List[float]] = Field([0, 1, 0], description="Light direction [x, y, z]")
...
class LocalPointLightConfig(ConfigBase):
    ...
    color: Optional[List[float]] = Field([1, 1, 1], description="Light color [r, g, b] or [r, g, b, a]")
    power: float = Field(1.0, description="Light power multiplier")
    attenuation: Optional[List[float]] = Field(
...
class LocalSpotLightConfig(ConfigBase):
    ...
    direction: Optional[List[float]] = Field([0, 1, 0], description="Spotlight direction [x, y, z]")
    shadows: Optional[ShadowsConfig] = Field(None, description="Shadow casting configuration")
