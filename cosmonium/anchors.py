...
try:
    ...
    print("\t", e)
    from .pyengine.pyanchors import UniverseAnchor, StellarAnchor, FixedStellarAnchor, DynamicStellarAnchor, SystemAnchor, OctreeAnchor, FindLightSourceTraverser
