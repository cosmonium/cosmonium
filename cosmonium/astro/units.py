...
diameter_scale = [
    ['Milky Way', milky_way_radius, milky_way_radius / 1000],
...
times_scale = [['Year', JYear, JYear], ['Day', Day, Day], ['Hour', Hour, Hour], ['Min', Min, Min], ['Sec', Sec, Sec]]
